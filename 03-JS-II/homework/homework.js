...
function fizzBuzz(numero) {
  ...
  if (numero/3 === Math.floor (numero/3) && numero/5 === Math.floor (numero/5)) return "fizzbuzz";
  if (numero/3 === Math.floor (numero/3)) return 'fizz';
  if (numero/5 === Math.floor (numero/5)) return 'buzz';
    else return (numero)
}
